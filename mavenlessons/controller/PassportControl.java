...
public class PassportControl {
	...
	private String redirectUrl = "/passport/getpassports";
	@GetMapping(value = "/getpassportbyid", produces = "application/json")
	public Passport getPassport(int id) {
		return passportservices.findPassportById(id);
	}
	@GetMapping(value = "/getpassports", produces = "application/json")
